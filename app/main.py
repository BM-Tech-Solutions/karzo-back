...
from app.api.v1.endpoints import candidates, jobs, interviews
...
# Add direct endpoints for jobs to bypass router issues
@app.get("/api/jobs")
...
# Comment out the interviews router to use our direct endpoints instead
